...
if( QT_STATIC )
    ...
    target_link_libraries( ${PROJECT_NAME} debug "$ENV{QTDIR}/lib/qtfreetyped.lib" )
    target_link_libraries( ${PROJECT_NAME} debug "$ENV{QTDIR}/lib/qtpcred.lib" )
    ...
    target_link_libraries( ${PROJECT_NAME} optimized "$ENV{QTDIR}/lib/qtfreetype.lib" )
    target_link_libraries( ${PROJECT_NAME} optimized "$ENV{QTDIR}/lib/qtpcre.lib" )
